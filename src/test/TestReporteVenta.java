...
public class TestReporteVenta {
    ...
    public static void main(String[] args) {
        ...
        ReporteVenta reporteVenta = new ReporteVenta(fecha1, fecha2, ventas);
        Ventas ventasAux = reporteVenta.getVentasTotales();
        ventasAux.imprimirVentas();
        System.out.println(reporteVenta.toString());
    }
}
